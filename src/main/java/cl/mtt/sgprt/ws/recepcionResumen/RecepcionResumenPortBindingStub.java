...
public class RecepcionResumenPortBindingStub extends Stub
  implements RecepcionResumenRemote
{
  ...
  public RecepcionResumenPortBindingStub() throws AxisFault
  {
    this(null);
  }

  public RecepcionResumenPortBindingStub(URL endpointURL, javax.xml.rpc.Service service) throws AxisFault {
    this(service);
    this.cachedEndpoint = endpointURL;
  }

  public RecepcionResumenPortBindingStub(javax.xml.rpc.Service service) throws AxisFault {
    if (service == null)
  ...
  public String recepcionResumen(String arg0) throws RemoteException {
    if (this.cachedEndpoint == null) {
    ...
    _call.setOperationName(new QName("http://recepcionResumen.ws.sgprt.mtt.cl/", "recepcionResumen"));
