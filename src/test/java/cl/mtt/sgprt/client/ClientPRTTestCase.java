...
package cl.mtt.sgprt.client;

import cl.mtt.sgprt.cliente.SGPRTException;
 ...
 * @author admin
 */
public class ClientPRTTestCase {
    
    public ClientPRTTestCase() {
    }
    ...
    public void sendPRT() {
        ...
        String documentoXML = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
    ...
    configuracion = ResourceBundle.getBundle("ConfiguracionCliente");        
