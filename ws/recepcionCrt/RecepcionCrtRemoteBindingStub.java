...
public class RecepcionCrtRemoteBindingStub extends Stub
  implements RecepcionCrtRemote
{
  ...
  public RecepcionCrtRemoteBindingStub() throws AxisFault
  {
    this(null);
  }

  public RecepcionCrtRemoteBindingStub(URL endpointURL, javax.xml.rpc.Service service) throws AxisFault
  {
    this(service);
    this.cachedEndpoint = endpointURL;
  }

  public RecepcionCrtRemoteBindingStub(javax.xml.rpc.Service service) throws AxisFault
  {
    if (service == null)
  ...
  public String recepcionCRT(String string_1) throws RemoteException
  {
    ...
    _call.setProperty("sendXsiTypes", 
      Boolean.FALSE);
    _call.setProperty("sendMultiRefs", 
      Boolean.FALSE);
    _call
      .setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
    _call.setOperationName(new QName(
      "http://recepcionCrt.ws.sgprt.mtt.cl/jaws", "recepcionCRT"));

    setRequestHeaders(_call);
    setAttachments(_call);
    try {
      Object _resp = _call
        .invoke(new Object[] { string_1 });
      ...
      try {
        ...
        return (String)
          JavaUtils.convert(_resp, String.class);
      }
    }
